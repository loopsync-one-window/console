...
import { ArrowRight, Download, CheckCircle, MousePointer, Command, Zap, ArrowUpRight, Upload, Bot, Play } from "lucide-react";

export default function CeresAssistProductPage() {
    return (
        <div className="min-h-screen bg-black text-white font-sans selection:bg-purple-500/30 overflow-x-hidden relative">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1 space-y-8">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold tracking-tight">
                            Ceres <span className="text-zinc-500">Assist</span>
                        </h1>

                        <p className="text-xl text-zinc-400 max-w-2xl leading-relaxed">
                            Your autonomous browser agent. Delegate complex web tasks and let Ceres handle the navigation, clicking, and data extraction for you.
                        </p>
            ...
            <section className="py-24 px-6 bg-[#050505] border-t border-white/5">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-20">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Autonomy at Your Fingertips</h2>
                        <p className="text-zinc-400">Automate your workflow in four simple steps.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative">
                        ...
                        <div className="relative group md:text-right pr-0 md:pr-12">
                            ...
                            <div className="relative z-10 flex flex-col md:items-end pl-12 md:pl-0">
                                ...
                                <p className="text-zinc-400 mb-4 mr-12">
                                    Download the Ceres extension from the Browser Web Store. It's lightweight and built for privacy.
                                </p>
                        ...
                        <div className="relative group pl-0 md:pl-12">
                            ...
                            <div className="relative z-10 pl-12">
                                ...
                                <p className="text-zinc-400 mb-4">
                                    Click the puzzle piece icon in your browser and pin Ceres for quick access to your autonomous agent.
                                </p>
                        ...
                        <div className="relative group md:text-right pr-0 md:pr-12">
                            ...
                            <div className="relative z-10 flex flex-col md:items-end pl-12 md:pl-0">
                                ...
                                <h3 className="text-xl font-semibold mb-2 text-white group-hover:text-white transition-colors mr-12">Describe Your Task</h3>
                                <p className="text-zinc-400 mb-4 mr-12">
                                    Open the extension and type what you need in plain English. e.g. "Find the cheapest flight to Tokyo."
                                </p>
                                <div className="inline-block p-4 rounded-xl bg-zinc-900/50 border border-white/5 mr-12">
                        ...
                        <div className="relative group pl-0 md:pl-12">
                            ...
                            <div className="relative z-10 pl-12">
                                ...
                                <h3 className="text-xl font-semibold mb-2 text-white group-hover:text-white transition-colors">Watch it Work</h3>
                                <p className="text-zinc-400 mb-4">
                                    Sit back as Ceres takes control within your browser tab, navigating and interacting automatically.
                                </p>
                                <div className="inline-block p-4 rounded-xl bg-zinc-900/50 border border-white/5">
            ...
            <section className="py-20 text-center">
                <div className="max-w-2xl mx-auto px-6">
                    <h2 className="text-3xl font-bold mb-6">Ready to delegate?</h2>
                    <button className="px-8 py-4 rounded-full bg-blue-600 text-white font-semibold hover:bg-blue-500 transition-all">
                        Add to Chrome
                    </button>
                </div>
            </section>
