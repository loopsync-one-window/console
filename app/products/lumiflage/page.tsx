...
import { ArrowRight, Download, CheckCircle, MousePointer, Command, Zap, ArrowUpRight, Upload, Lightbulb, Video, Sun, Moon } from "lucide-react";

export default function LumiflageProductPage() {
    return (
        <div className="min-h-screen bg-black text-white font-sans selection:bg-orange-500/30 overflow-x-hidden relative">
            {/* Navbar */}
            <Navbar />
                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1 space-y-8">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold tracking-tight">
                            Lumi<span className="text-zinc-500">flage</span>
                        </h1>

                        <p className="text-xl text-zinc-400 max-w-2xl leading-relaxed">
                            Look your best on every call. A soft, adjustable screen light that keeps your face perfectly illuminated, even in the darkest rooms.
                        </p>
            ...
            <section className="py-24 px-6 bg-[#050505] border-t border-white/5">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-20">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Studio Lighting, Minus the Studio</h2>
                        <p className="text-zinc-400">Get professional lighting using just your screen.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative">
                        ...
                        <div className="relative group md:text-right pr-0 md:pr-12">
                            ...
                            <div className="relative z-10 flex flex-col md:items-end pl-12 md:pl-0">
                                ...
                                <h3 className="text-xl font-semibold mb-2 text-white group-hover:text-white transition-colors mr-12">Simple Installation</h3>
                                <p className="text-zinc-400 mb-4 mr-12">
                                    Download Lumiflage for Windows or macOS. It's a tiny utility that sits in your menu bar.
                                </p>
                        ...
                        <div className="relative group pl-0 md:pl-12">
                            ...
                            <div className="relative z-10 pl-12">
                                ...
                                <h3 className="text-xl font-semibold mb-2 text-white group-hover:text-white transition-colors">Toggle Instantly</h3>
                                <p className="text-zinc-400 mb-4">
                                    Turn the light on or off with a global hotkey or a single click, perfectly timed for your meeting.
                                </p>
                        ...
                        <div className="relative group md:text-right pr-0 md:pr-12">
                            ...
                            <div className="relative z-10 flex flex-col md:items-end pl-12 md:pl-0">
                                ...
                                <h3 className="text-xl font-semibold mb-2 text-white group-hover:text-white transition-colors mr-12">Adjust Warmth & Brightness</h3>
                                <p className="text-zinc-400 mb-4 mr-12">
                                    Customize the color temperature and intensity to match your environment and skin tone.
                                </p>
                                <div className="inline-block p-4 rounded-xl bg-zinc-900/50 border border-white/5 mr-12">
                        ...
                        <div className="relative group pl-0 md:pl-12">
                            ...
                            <div className="relative z-10 pl-12">
                                ...
                                <h3 className="text-xl font-semibold mb-2 text-white group-hover:text-white transition-colors">Video Call Ready</h3>
                                <p className="text-zinc-400 mb-4">
                                    Compatible with Zoom, Teams, Meet, and any other video conferencing tool.
                                </p>
                                <div className="inline-block p-4 rounded-xl bg-zinc-900/50 border border-white/5">
            ...
            <section className="py-20 text-center">
                <div className="max-w-2xl mx-auto px-6">
                    <h2 className="text-3xl font-bold mb-6">Light up your calls.</h2>
                    <button className="px-8 py-4 rounded-full bg-blue-500 text-white font-semibold hover:bg-blue-400 transition-all">
                        Get Lumiflage Free
                    </button>
                    <p className="mt-4 text-sm text-zinc-500">For macOS and Windows</p>
                </div>
            </section>
